    ...
    <div class="col">
              ...
              <div class="card-body">
                <div class="row mb-3">
                  ...
                  <div class="col-md-3 d-flex justify-content-start align-items-center">
                    <a href="<?= base_url(); ?>tanah/create" class="btn btn-primary">
                      <i class="fas fa-plus"></i> Tambah
                    </a>
                    <a href="">.</a>
                    <!-- Adding more space between the buttons -->
                    <a href="<?= base_url(); ?>tanah/export" class="btn btn-success ml-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <select id="filter-satker" name="satker" class="form-control">
                      ...
                      <?php foreach (array_unique(array_column($tanah, 'nama_satker')) as $satker): ?>
                  ...
                  <div class="col-md-3">
                    ...
                    <select id="filter-status" name="status" class="form-control">
                      ...
                      <?php foreach (array_unique(array_column($tanah, 'status')) as $status): ?>
                  ...
                  <tbody>
                    <?php foreach ($tanah as $key => $value): ?>
                      <tr>
                        ...
                        <td><?= $value['status'] ?></td>
                        <td>
                          <form action="<?= base_url('tanah/edit/' . $value['id_tanah']) ?>" method="post"
                            style="display: inline-block;">
                            <button type="submit" class="btn btn-sm btn-primary">
                              <i class="fas fa-edit"></i>
                            </button>
                          </form>
                          <form action="<?= base_url('tanah/delete/' . $value['id_tanah']) ?>"
                            onsubmit="return confirm('Apakah Anda yakin ingin menghapus data tanah ini?')"
                            style="display: inline-block;">
      ...
      <script>
        $(document).ready(function () {
          // Initialize DataTable with scrollX and scrollY options
          var table = $('#basic-datatables').DataTable({
            "scrollX": true, // Enable horizontal scroll
            "scrollY": "400px", // Set height for vertical scroll
          ...
          // Filters and row number reset logic as in your code

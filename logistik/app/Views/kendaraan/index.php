            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="/kendaraan/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
                  <!-- <a href="/kendaraan/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <a href="/kendaraan/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a>
                </div>
                              ...
                              <tbody>
                                <?php foreach ($kendaraan as $key => $value) : ?>
                                  <tr>
                                    ...
                                    <td><?= $value['jabatan'] ?></td>
                                    <td style="width:20%;">
                                      <form action="<?= base_url('kendaraan/edit/' . $value['id_kendaraan']) ?>" method="post" style="display: inline-block;">
                                        <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                          <i class="fas fa-edit"></i>
                                        </button>
                                      </form>
                                      <form action="<?= base_url('kendaraan/delete/' . $value['id_kendaraan']) ?>" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data kendaraan ini?')" style="display: inline-block;">

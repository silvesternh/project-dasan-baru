      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">DATA PERSONIL BERSERTIFIKASI</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="/sertifikasi/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
                  <!-- <a href="/sertifikasi/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <a href="/sertifikasi/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a>
                </div>
                              ...
                              <tbody>
                                <?php foreach ($sertifikasi as $key => $value) : ?>
                                  <tr>
                                    ...
                                    <td><?= $value['hp'] ?></td>
                                    <td style="width: 80px;">
                                      <form action="<?= base_url('sertifikasi/edit/' . $value['id_sertifikasi']) ?>" method="post" style="display: inline-block;">
                                        <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                          <i class="fas fa-edit"></i>
                                        </button>
                                      </form>
                                      <form action="<?= base_url('sertifikasi/delete/' . $value['id_sertifikasi']) ?>" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data sertifikasi ini?')" style="display: inline-block;">

              ...
              <div class="card-body">
                <div class="row mb-3">
                  ...
                  <div class="col-md-3 d-flex justify-content-start align-items-center">
                    <a href="<?= base_url(); ?>sertifikasi/create" class="btn btn-primary">
                      <i class="fas fa-plus"></i> Tambah
                    </a>
                    <a href="">.</a>
                    <!-- Adding more space between the buttons -->
                    <a href="<?= base_url(); ?>sertifikasi/export" class="btn btn-success ml-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <select id="filter-satker" name="satker" class="form-control">
                      ...
                      <?php foreach (array_unique(array_column($sertifikasi, 'nama_satker')) as $satker): ?>
                    ...
                    <?php foreach ($sertifikasi as $key => $value): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <form action="<?= base_url('sertifikasi/delete/' . $value['id_sertifikasi']) ?>"
                            onsubmit="return confirm('Apakah Anda yakin ingin menghapus data sertifikasi ini?')"
                            style="display: inline-block;">
      ...
      <script>
        $(document).ready(function () {
          ...
          $('.btn-success').on('click', function (e) { // Make sure the "Ekspor" button is clicked
            ...
            const exportUrl = `<?= base_url(); ?>/sertifikasi/export?nama_satker=${satker}&kondisi=${kondisi}`;

      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">DATA PENGADAAN</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="/pengadaan/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
                  <!-- <a href="/pengadaan/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <a href="/pengadaan/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a>
                </div>
                              ...
                              <tbody>
                                <?php foreach ($pengadaan as $key => $value) : ?>
                                  <tr>
                                    ...
                                    <td><?= $value['metode'] ?></td>
                                    <td style="width: 80px;">
                                      <form action="<?= base_url('pengadaan/edit/' . $value['id_pengadaan']) ?>" method="post" style="display: inline-block;">
                                        <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                          <i class="fas fa-edit"></i>
                                        </button>
                                      </form>
                                      <form action="<?= base_url('pengadaan/delete/' . $value['id_pengadaan']) ?>" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data pengadaan ini?')" style="display: inline-block;">

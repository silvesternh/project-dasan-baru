                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <?php endif; ?>
                                <form action="<?= base_url(); ?>/alkes/update/<?= $alkes['id_alkes']; ?>" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <select class="form-control" name="id_satker" id="exampleFormControlSelect1">
                                                ...
                                                foreach ($satker as $s): ?>
                                                    <option value="<?= $s->id_satker ?>" <?= $alkes['id_satker'] == $s->id_satker ? 'selected' : '' ?>><?= $s->nama_satker ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="jumlah" name="jumlah" value="<?= $alkes['jumlah']; ?>">
                                        </div>
                                    </div>

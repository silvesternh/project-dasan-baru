                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-3 d-flex justify-content-start align-items-center">
                                        <a href="<?= base_url(); ?>alkes/create" class="btn btn-primary">
                                            <i class="fas fa-plus"></i> Tambah
                                        </a>
                                        <a href="">.</a>
                                        <!-- Adding more space between the buttons -->
                                        <a href="<?= base_url(); ?>alkes/export" class="btn btn-success ml-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="filter-satker" name="satker" class="form-control">
                                            ...
                                            <?php foreach (array_unique(array_column($alkes, 'nama_satker')) as $satker): ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="filter-bmn" name="bmn" class="form-control">
                                            ...
                                            <?php foreach (array_unique(array_column($alkes, 'bmn')) as $bmn): ?>
                                    ...
                                    <tbody>
                                        <?php foreach ($alkes as $key => $value): ?>
                                            <tr>
                                                ...
                                                <td><?= $value['ket'] ?></td>
                                                <td>
                                                    <form action="<?= base_url('alkes/edit/' . $value['id_alkes']) ?>" method="post"
                                                        style="display: inline-block;">
                                                        <button type="submit" class="btn btn-sm btn-primary">
                                                            <i class="fas fa-edit"></i>
                                                        </button>
                                                    </form>
                                                    <form action="<?= base_url('alkes/delete/' . $value['id_alkes']) ?>"
                                                        onsubmit="return confirm('Apakah Anda yakin ingin menghapus data alkes ini?')"
                                                        style="display: inline-block;">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('.btn-success').on('click', function(e) {
                        ...
                        const exportUrl = `<?= base_url(); ?>/alkes/export?nama_satker=${satker}&bmn=${bmn}`;

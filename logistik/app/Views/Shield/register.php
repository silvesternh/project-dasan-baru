        ...
        <div class="card-body">
            ...
            <form action="<?= url_to('register') ?>" method="post">
                ...
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="floatingNamaInput" name="nama" autocomplete="name"
                        placeholder="Nama" value="<?= old('nama') ?>" required>
                    <label for="floatingNamaInput">Nama:</label>
                </div>
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="floatingPangkatInput" name="pangkat"
                        autocomplete="pangkat" placeholder="Pangkat" value="<?= old('pangkat') ?>" required>
                    <label for="floatingPangkatInput">Pangkat:</label>
                </div>
                <div class="form-floating mb-2">
                    <input type="text" class="form-control" id="floatingNrpInput" name="nrp" autocomplete="nrp"
                        placeholder="NRP" value="<?= old('nrp') ?>" required>
                    <label for="floatingNrpInput">NRP:</label>
                </div>
                <div class="form-floating mb-4">
                    <input type="text" class="form-control" id="floatingJabatanInput" name="jabatan"
                        autocomplete="jabatan" placeholder="Jabatan" value="<?= old('jabatan') ?>" required>
                    <label for="floatingJabatanInput">Jabatan:</label>
                </div>

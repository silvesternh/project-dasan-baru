      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">DATA JENIS SENPI</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="<?= base_url(); ?>jenis/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i>
                    Tambah Data</a>
                  <!-- <a href="<?= base_url(); ?>jenis/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <!-- <a href="<?= base_url(); ?>jenis/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a> -->
                  <a href="">.</a>
                  <!-- New Refresh Button -->
                          ...
                          <div class="col-sm-12">
                            <table id="basic-datatables" class="display table table-striped table-hover dataTable"
                              ...
                              <thead>
                                <tr>
                                  <th>NO</th>
                                  <th style="width:30%">Jenis Senpi</th>
                                  <th>AKSI</th>
                                </tr>
                              </thead>
                              <tbody>
                                <?php foreach ($jenis as $key => $value): ?>
                                    <tr>
                                      ...
                                      <td style="width: 78%;"><?= $value['nama_jenis'] ?></td>
                                      <td style="width: 80px;">
                                        <form action="<?= base_url('jenis/edit/' . $value['id_jenis']) ?>" method="post"
                                          style="display: inline-block;">
                                          <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                            <i class="fas fa-edit"></i>
                                          </button>
                                        </form>
                                        <form action="<?= base_url('jenis/delete/' . $value['id_jenis']) ?>"

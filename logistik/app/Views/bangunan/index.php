      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">DATA BANGUNAN</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="/bangunan/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
                  <!-- <a href="/bangunan/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <a href="/bangunan/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a>
                </div>
                            ...
                            <table id="basic-datatables" class="display table table-striped table-hover dataTable" role="grid" aria-describedby="basic-datatables_info">
                              ...
                              <tbody>
                                <?php foreach ($bangunan as $key => $value) : ?>
                                  <tr>
                                    <td><?= $key + 1 ?></td>
                                    <td style="width:25%"><?= $value['gedung'] ?></td>
                                    <td style="width:10%"><?= $value['unit'] ?></td>
                                    <td style="width:10%"><?= $value['penghuni'] ?></td>
                                    <td style="width:20%"><?= $value['kondisi'] ?></td>
                                    <td style="width:20%"><?= $value['ket'] ?></td>
                                    <td style="width:12%;">
                                      <form action="<?= base_url('bangunan/edit/' . $value['id_bangunan']) ?>" method="post" style="display: inline-block;">
                                        <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                          <i class="fas fa-edit"></i>
                                        </button>
                                      </form>
                                      <form action="<?= base_url('bangunan/delete/' . $value['id_bangunan']) ?>" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data bangunan ini?')" style="display: inline-block;">

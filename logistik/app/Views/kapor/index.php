      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">DATA KAPOR</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="/kapor/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i> Tambah Data</a>
                  <!-- <a href="/kapor/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <a href="/kapor/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a>
                </div>
                              ...
                              <tbody>
                                <?php foreach ($kapor as $key => $value) : ?>
                                  <tr>
                                    ...
                                    <td><?= $value['tahun'] ?></td>
                                    <td style="width: 80px;">
                                      <form action="<?= base_url('kapor/edit/' . $value['id_kapor']) ?>" method="post" style="display: inline-block;">
                                        <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                          <i class="fas fa-edit"></i>
                                        </button>
                                      </form>
                                      <form action="<?= base_url('kapor/delete/' . $value['id_kapor']) ?>" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data kapor ini?')" style="display: inline-block;">

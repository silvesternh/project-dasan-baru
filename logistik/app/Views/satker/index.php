      ...
      <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">DATA SATKER</h3>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <a href="<?= base_url(); ?>satker/create" class="btn btn-primary mr-2"><i class="fas fa-plus"></i>
                    Tambah Data</a>
                  <!-- <a href="<?= base_url(); ?>satker/impor" class="btn btn-danger ml-auto"><i class="fas fa-upload"></i></a> -->
                  <!-- <a href="<?= base_url(); ?>satker/export" class="btn btn-success ml-auto"><i class="fas fa-file-export"> Ekspor Data</i></a> -->
                  <a href="">.</a>
                  <!-- New Refresh Button -->
                              ...
                              <tbody>
                                <?php foreach ($satker as $key => $value): ?>
                                    <tr>
                                      ...
                                      <td style="width: 78%;"><?= $value['nama_satker'] ?></td>
                                      <td style="width: 80px;">
                                        <form action="<?= base_url('satker/edit/' . $value['id_satker']) ?>" method="post"
                                          style="display: inline-block;">
                                          <button type="submit" class="btn btn-sm btn-primary" style="padding: 8px 10px;">
                                            <i class="fas fa-edit"></i>
                                          </button>
                                        </form>
                                        <form action="<?= base_url('satker/delete/' . $value['id_satker']) ?>"
                                          onsubmit="return confirm('Apakah Anda yakin ingin menghapus data satker ini?')"
                                          style="display: inline-block;">
                              ...
                              <script>
                                ...
                                $(document).ready(function () {
                                  $('#filter-form').submit(function (e) {
                                    ...
                                    $.ajax({
                                      type: 'POST',
                                      url: '<?= base_url('satker/filterData') ?>',
                                      data: formData,
                                      dataType: 'json',
